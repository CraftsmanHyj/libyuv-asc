...
JNIEXPORT void JNICALL
Java_cn_ibingli_library_yuv_YuvUtils_bitmap2i420WithC(JNIEnv *env, jclass type,
...
JNIEXPORT void JNICALL
Java_cn_ibingli_library_yuv_YuvUtils_convertMJPEGToI420(JNIEnv *env, jclass type, jbyteArray src_frame_,
